...
let tests = document.querySelector("#input_test_1").value + 1;
console.log(tests);
...
function F1 (){
    let test = document.querySelector("#input_test_1").value;
    test = parseInt(test);
    console.log(test + 23);
}
...
button_test_1.addEventListener("click", function (){console.log(input_test_1.value)});
button_test_1.addEventListener("click", function (){F1()});
